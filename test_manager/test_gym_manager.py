...
class GymManagerTest(unittest.TestCase):
    def setUp(self):
        self.first_machine = MainExerciseMachine(40, 34, "UKRAINE", "SH_URA")
        self.second_machine = MainExerciseMachine(30, 45, "Russia", "vodka")
        self.third_machine = MainExerciseMachine(50, 67, "USA", "say_ga")
        self.fourth_machine = MainExerciseMachine(60, 89, "Uganda", "old_school")
...
class TestFinding(GymManagerTest):
    def test_finding_by_price(self):
        self.assertEqual(first=self.gym_manager.find_exercise_machine_by_price(40), second=[self.first_machine])
