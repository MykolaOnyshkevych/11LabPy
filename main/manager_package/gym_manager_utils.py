...
class GymManagerUtils:
    ...
    def sort_by_duration(exercise_machine_list, sort_type):
        """
        Sorting by duration
        >>> new_created_list = [MainExerciseMachine(0, 30, "none", "none"), \
        MainExerciseMachine(0, 25, "none", "none"), MainExerciseMachine(0, 40, "none", "none")]
    ...
    def sort_by_price(exercise_machine_list, sort_type):
        """
        Sorting by price
        >>> new_created_list = [MainExerciseMachine(30, 0, "none", "none"), \
        MainExerciseMachine(25, 0, "none", "none"), MainExerciseMachine(40, 0, "none", "none")]
